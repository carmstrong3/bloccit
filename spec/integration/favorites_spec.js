...
// Clear database and create new objects
   ...
   }); // End sequelize context
 }); // End before each context
...
// Take note of the number of favorites that exist for the post before sending the delete request and check that the number of favorites has not changed to confirm non-deletion.
