...
describe("Vote", () => {
 ...
 // Clear the database and create new objects
  ...
  // Define suite for create action
  describe("#create()", () => {

  // Check that upvote is created successfully
  ...
  // Check that a vote is not created with a userId or postId assigned
